...
if __name__=="__main__":
    ...
    # dataset
    training_set = datasets.HorseDataset(args.dataset_root, (args.y_size[1], args.y_size[2]), args.y_size[0], "train")
    valid_set = datasets.HorseDataset(args.dataset_root, (args.y_size[1], args.y_size[2]), args.y_size[0], portion="valid")
